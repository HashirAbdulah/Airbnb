...
const Reservations = () => {
  return (
    <main className="max-w-screen-xl mx-auto px-6 mb-6 mt-4">
            <h1 className="my-6 text-2xl">Reservations</h1>
                {/* Reservtion div */}
            <div className="mt-4">
                <div className="p-5 grid grid-col-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300 rounded-xl">
                    ...
                    <div className="col-span-1 md:col-span-3">
                        ...
                        <p className="mb-2"><strong>Check in date:</strong> 09/03/2025</p>
                        <p className="mb-2"><strong>Check out date:</strong> 09/03/2025</p>
                        <p className="mb-2"><strong>Number of Nights:</strong> 2</p>
                        <p className="mb-2"><strong>Total Price:</strong> $83</p>
